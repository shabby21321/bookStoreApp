...
function Navbar() {
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 top-0 left-0 right-0 fixed z-50 ${
      sticky ? "sticky-navbar shadow-md bg-base-200 duration-400 fixed transition-all ease-in-out" : ""
    }`}>
